...
public static class DotNetCustomAliases
{
    ...
    public static void DotNetAddPackage(this ICakeContext context, FilePath project, string package, string? version = null)
    {
        var runner = new DotNetAddPackageRunner(context.FileSystem, context.Environment, context.ProcessRunner, context.Tools);
        runner.AddPackage(project, package, version, new IgnoredDotNetSettings());
    }
...
public sealed class DotNetAddPackageRunner : DotNetCoreTool<IgnoredDotNetSettings>
{
    ...
    public void AddPackage(FilePath project, string packageName, string? version, IgnoredDotNetSettings settings)
    {
        var builder = new ProcessArgumentBuilder();
